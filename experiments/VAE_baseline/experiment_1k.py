"""
experiments similar to those in experiment.py, but with limited dataset of approx. 1k examples
"""
...
def run_experiment(option):
    ...
    elif option == 'simple_1024_no_limit':
        tensor_names = build_simple_network2(x, X_SHAPE, 1024, kl_limit=None)
    ...
    logdir = 'experiments/VAE_baseline/{}_1k'.format(option)
