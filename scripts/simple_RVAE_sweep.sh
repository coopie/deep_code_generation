...
./scripts/gdrive upload --recursive experiments/Recurrent_VAE_baseline/single_layer_gru_16
$COMMAND single_layer_gru_32
./scripts/gdrive upload --recursive experiments/Recurrent_VAE_baseline/single_layer_gru_32
$COMMAND single_layer_gru_64
./scripts/gdrive upload --recursive experiments/Recurrent_VAE_baseline/single_layer_gru_64
$COMMAND single_layer_gru_128
./scripts/gdrive upload --recursive experiments/Recurrent_VAE_baseline/single_layer_gru_128
$COMMAND single_layer_gru_256
./scripts/gdrive upload --recursive experiments/Recurrent_VAE_baseline/single_layer_gru_256
