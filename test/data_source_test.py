...
from pipelines.data_sources import HuzzerSource, CharSplitter, OneHotVecotorizer
...
def test_one_hot():
    expected_length = 10
    one_hotter = OneHotVecotorizer(CharSplitter(HuzzerSource()), total_string_length=expected_length)
